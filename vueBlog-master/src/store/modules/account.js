...
const state = {
  ...
  auth: {
    ...
    clientID: 'ac2c082a2889f1f4ba96',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
    clientSecret: '49e43bf15e617bd04cec890688b00449144f0a42'  // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client Secret
  },
  gitHubUser: null,  // 这个不要修改，这个不要修改，这个不要修改。
  gitHubUsername: 'musicvv520',  // 修改成你自己的 GitHub 账号
  copyright: '2016 - 2018',  // 修改成你自己的
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/musicvv520'  // 第三方站点的 url
    }
